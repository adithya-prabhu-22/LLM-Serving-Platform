...
def test_load_model_weights():
    ...
    test_dir = Path("tests/resources/model_loader")
    ...
    loaded_model = load_model(config_path=config_path, weights_path=weights_path)
...
def run_all_tests():
    print("\nRunning Model Loader Weights tests...\n")
    test_load_model_weights()
    print("\n✓ All Model Loader Weights tests passed")
