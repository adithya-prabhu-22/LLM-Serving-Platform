...
from backend.services.inference_engine import build_model, unload_model, generate
...
def test_generate_text():
    ...
    test_dir = Path("tests/resources/inference_generation")
...
def run_all_tests():
    ...
    test_generate_text()
    print("\n✓ All Inference Generation tests passed")
