...
from core.models.activations import get_activation

class FeedForward(nn.Module):
    def __init__(self, d_model: int, ff_dim: int | None = None, activation: str = "gelu", dropout: float = 0.1, bias: bool = True):
        super().__init__()
        if d_model <= 0:
